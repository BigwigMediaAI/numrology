      ...
      <div className="relative z-10 w-11/12 md:w-4/5 mx-auto text-center">
        ...
        <div className="hidden md:grid grid-cols-3 gap-8 ">
          {services.map((item, index) => (
            <div
              key={index}
              className="rounded-xl bg-transparent border border-gray-700 hover:border-[#b19768] hover:bg-[#e5d6e0] hover: transition p-8 flex flex-col items-center text-center"
              data-aos="fade-up"
